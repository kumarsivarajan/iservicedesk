...
version 0.12.0
added SLIDETOP animation - wayne
line 3869 - IE bug fix wayne
*/
...
/**
* A pre-configured ContainerEffect instance that can be used for sliding an overlay in and out.
* Effect slides to the top
* @param {Overlay}	The Overlay object to animate
* @param {float}	The duration of the animation
* @type ContainerEffect
*/
YAHOO.widget.ContainerEffect.SLIDETOP = function(overlay, dur) {
	var x = overlay.cfg.getProperty("x") || YAHOO.util.Dom.getX(overlay.element);
	var y = overlay.cfg.getProperty("y") || YAHOO.util.Dom.getY(overlay.element);
	...
	var slide = new YAHOO.widget.ContainerEffect(overlay, {
															attributes:{ points: { to:[x, document.body.scrollTop + 50] } },
															duration:dur,
															method:YAHOO.util.Easing.easeIn
														},
														{
															attributes:{ points: { to:[x, -25-offsetHeight] } },
															duration:dur,
															method:YAHOO.util.Easing.easeOut
														},
														overlay.element,
	...
	slide.handleStartAnimateOut = function(type, args, obj) {
		...
		var currentTo = obj.animOut.attributes.points.to;
		obj.animOut.attributes.points.to = [x, (-25-offsetHeight)];
	}
